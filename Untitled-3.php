...
if (empty($_SESSION["sidx"]) || $_SESSION["role"] !== 'student') {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['document'])) {
    ...
    $category = 'submit'; // Default category for students
...
// $query = "SELECT * FROM documents WHERE user_id = ? AND category IN ('note', 'assignment', 'correction')";
